...
/**
 * ImageLoader 소스를 그대로 차용하여 Config, 캐쉬 설정부분 추가 
 */
public class VolleyImageLoader {
    ...
    public ImageContainer get(String requestUrl, final ImageListener listener) {
        return get(requestUrl, Config.RGB_565, true, listener, 0, 0);
    }
     ...
     * @return
     */
    public ImageContainer get(String requestUrl, Config config, final ImageListener listener) {
        return get(requestUrl, config, true, listener, 0, 0);
    }
     ...
     * @return
     */
    public ImageContainer get(String requestUrl, Config config, boolean shouldCache, ImageListener listener) {
        return get(requestUrl, config, shouldCache, listener, 0, 0);
    }
     ...
     */
    public ImageContainer get(String requestUrl, Config config, boolean shouldCache, ImageListener imageListener, int maxWidth, int maxHeight) {
        ...
        }, maxWidth, maxHeight, config, new ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
