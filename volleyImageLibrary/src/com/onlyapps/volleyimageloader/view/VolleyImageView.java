package com.onlyapps.volleyimageloader.view;
...
/**
 * Volley NetworkImageView 커스텀 뷰 ImageLoadingListener 리스너 추가 ( 기능은 동일 )
 * [ 참고링크 ]
 * - https://android.googlesource.com/platform/frameworks/volley/+/c3dea925af9b3523e2e01e8b7799e71ef558c1c5/src/com/android/volley/toolbox/NetworkImageView.java
 */
public class VolleyImageView extends ImageView {
    ...
    public void setFitToScreen(boolean isFitScreen) {
        this.mIsFitToScreen = isFitScreen;
    }
     ...
     */
    public void setImageUrl(String url, VolleyImageLoader imageLoader) {
        mUrl = url;
    ...
    private void loadImageIfNecessary(final boolean isInLayoutPass) {
        ...
        // from the network.
        ImageContainer newContainer = mImageLoader.get(mUrl, mBitmapConfig, new ImageListener() {
            @Override
            ...
            public void onResponse(final ImageContainer response, boolean isImmediate) {
                ...
                Bitmap cachBitmap = response.getBitmap();
                if (cachBitmap != null) {
                    setImageBitmap(cachBitmap);
        ...
        if (newContainer != null) {
            Bitmap cachBitmap = newContainer.getBitmap();
            if (cachBitmap != null) {
                setImageBitmap(cachBitmap);
            }
        }
    ...
    public void setImageBitmap(Bitmap bm) {
        ...
        if (isFitToScreen()) {
            ScreenUtils.fitToScreen(this, bm);
        }
        if (mImageLoadingListener != null) {
            mImageLoadingListener.onComplete(this, bm);
        }
    }
